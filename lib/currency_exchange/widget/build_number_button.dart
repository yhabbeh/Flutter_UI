  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
          ...
          child:  widget.num=="true"?const Icon(Icons.done,color: Colors.white,)
              :
          Text(widget.num.toString(),style: const TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.w600))
