...
class InputRedPge extends StatefulWidget {
  ...
  @override
  State<InputRedPge> createState() => _InputRedPgeState();
}

class _InputRedPgeState extends State<InputRedPge> {
            ...
            child: GridView.count(
              ...
              children:  [
                ...
                BuildNumberButton(
                    num: "true",
                    calculateNumber:(){
                      CurrencyService().convertCurrency(widget.originalCurrency, widget.convertedCurrency, CurrInput, context);
